...
const themeRef = document.querySelector(".theme");

const docElement = document.documentElement;
const darkQuery = window.matchMedia("(prefers-color-scheme: dark)");

checkboxRef.addEventListener("click", () => {
  if (checkboxRef.checked) {
    docElement.className = "dark";
    checkboxRef.setAttribute("checked", true);
    localStorage.setItem("theme", "dark");
    themeRef.innerHTML = `<svg viewBox="0 0 24 24" fill="none" class="moon-icon">
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
